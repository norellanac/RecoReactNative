...
with_node \
  ...
  --target "/Users/maynor/Desktop/DevProjects/JavaScript/React/projectx-mobile/ios/Pods/Target Support Files/Pods-Reco/ExpoModulesProvider.swift" \
  --entitlement "/Users/maynor/Desktop/DevProjects/JavaScript/React/projectx-mobile/ios/Reco/Reco.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-splash-screen" "expo-system-ui" "expo-tracking-transparency" "expo-web-browser" "react-native-fbsdk-next"
